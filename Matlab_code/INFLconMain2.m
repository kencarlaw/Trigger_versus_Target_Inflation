...
[acf40,lag40]=autocorr(icon(12,4:5*Block));
[acf41,lag41]=autocorr(icon(14,4:5*Block));
[acf42,lag42]=autocorr(icon(19,4:5*Block));
...
ylabel('{\it{i}} = 1.0%','FontSize',15)
ytickformat('percentage');
ylim([-0.02*100 0.25*100])
xlim([1 5000])
nexttile(6,[1 3]) 
...
%xlabel('Lags')
nexttile(21,[1 3])
plot(icon(12,1000:6000)*100,'Color',[0.5 0.5 0.5])
ylabel('{\it{i}} = 2.75%','FontSize',15)
ytickformat('percentage');
ylim([-0.02*100 0.25*100])
xlim([1 5000])
nexttile(26,[1 3]) 
plot(rfcon(12,1000:6000),'Linestyle','--','Color',[0.5 0.5 0.5])
ylabel('Info','FontSize',15)
ylim([0 100])
xlim([1 5000])
nexttile(24,[2 1])
histogram(icon(12,1000:6000),'Normalization','probability','FaceColor',[0.2 0.2 0.2],'BinWidth',0.01)
xlim([-0.02 0.25])
ylim([0 0.15])
view(90,-90)
nexttile(25,[2 1])
...
%xlabel('Lags')
nexttile(31,[1 3])
plot(icon(14,1000:6000)*100,'Color',[0.5 0.5 0.5])
ylabel('{\it{i}} = 3.25%','FontSize',15)
ytickformat('percentage');
ylim([-0.02*100 0.25*100])
xlim([1 5000])
nexttile(36,[1 3]) 
plot(rfcon(14,1000:6000),'Linestyle','--','Color',[0.5 0.5 0.5])
ylabel('Info','FontSize',15)
ylim([0 100])
xlim([1 5000])
nexttile(34,[2 1])
histogram(icon(14,1000:6000),'Normalization','probability','FaceColor',[0.2 0.2 0.2],'BinWidth',0.01)
xlim([-0.02 0.25])
ylim([0 0.15])
view(90,-90)
nexttile(35,[2 1])
...
xlim([0 4]);
nexttile(41,[1 3])
plot(icon(19,1000:6000)*100,'Color',[0.5 0.5 0.5])
%title('Panel 6: R = 43')
ytickformat('percentage');
ylim([-0.01*100 0.25*100])
xlim([1 5000])
ylabel('{\it{i}} = 4.5%','FontSize',15)
nexttile(46,[1 3]) 
plot(rfcon(19,1000:6000),'Linestyle','--','Color',[0.5 0.5 0.5])
ylabel('Info','FontSize',15)
ylim([0 100])
xlim([1 5000])
xlabel('Period (T = 0,...,5000)','FontSize',20)
nexttile(44,[2 1])
histogram(icon(19,1000:6000),'Normalization','probability','FaceColor',[0.2 0.2 0.2],'BinWidth',0.01)
xlim([-0.01 0.25])
ylim([0 0.15])
